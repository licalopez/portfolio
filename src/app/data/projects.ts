export const PROJECTS: Project[] = [
	{
		...
		images: [
			{ fileName: 'project1-01', alt: 'LN Associattttes Inc. Home Page' },
			{ fileName: 'project1-02', alt: 'Tablet and phone mockups of LN Associates Inc. About Page — featuring details about company team and company mission' },
			{ fileName: 'project1-03', alt: 'LN Associates Inc. About Page - featuring details about company team and company mission' },
			{ fileName: 'project1-04', alt: 'LN Associates Inc. Contact Page - showing business address, phone number, email, and location via Google Map' },
		],
	...
	},
	{
		...
		images: [
			{ fileName: 'project2-01', alt: 'Main "Posts" page in light mode, showing individual posts lined in a masonry layout' },
			{ fileName: 'project2-02', alt: 'Laptop and phone mockups of the Emma\'s Blog home page — the laptop version is in light mode while the phone version is displayed in dark mode' },
			{ fileName: 'project2-03', alt: 'Edit Post page in dark mode, showing a form populated with a post\'s "Title", "Image URL" and "Body" fields' },
			{ fileName: 'project2-04', alt: 'Tablet and phone mockups of the Emma\'s Blog Post show page. The tablet version is in dark mode, the phone version is in light mode.' }
		],
		launchedSite: null,
		repoLink: null
	},
	{
		...
		filters: ['HTML', 'CSS', 'Sass', 'React', 'Node.js', 'Next.js', 'Sanity.io', 'Stripe', 'APIs'],
		images: [
			{ fileName: 'project3-01', alt: 'Camera Shop\'s Home page showing a navbar, a large Hero banner and a gallery of best selling products' },
			{ fileName: 'project3-02', alt: 'Camera Shop\'s Product show page displaying thumbnail images, price and description of the camera product, along with buttons to "Add to Cart" or "Buy Now"' },
			{ fileName: 'project3-03', alt: 'Laptop and phone mockups of the Camera Shop\'s Cart modal' },
			{ fileName: 'project3-04', alt: 'Camera Shop\'s Brand page showing a filter of brand names on the left sidebar panel and a gallery view of products on the right side' }
		],
	...
	},
	{
		...
		images: [
			{ fileName: 'project4-01', alt: 'Bliss on Earth landing page' },
			{ fileName: 'project4-02', alt: 'Bliss on Earth about page, with "Get To Know Me" section and ThetaHealing disclaimer' },
			{ fileName: 'project4-03', alt: 'Tablet mockup of Bliss on Earth\'s About page, next to a phone mockup of their Services\' "Book an Appointment" section' },
			{ fileName: 'project4-04', alt: 'List of certifications, services and prices, with a PayPal button for services payment, and photos of a lotus flower and a burning incense' },
			// { fileName: 'project4-04', alt: 'Section to book an appointment and view contact info, and ThetaHealing disclaimer' },
		],
	...
	},
	{
		...
		images: [
			{ fileName: 'project5-02', alt: 'Photo Gallery Site Landing Page' },
			{ fileName: 'project5-01', alt: 'Laptop and phone mockups of Photo Gallery site\'s landing page' },
			{ fileName: 'project5-03', alt: 'Gallery page showing fixed menu bars and grid-aligned thumbnail images' },
			{ fileName: 'project5-04', alt: 'Full-screen show page with image on the left; title, date, caption, and navigation controls on the right' },
			// { fileName: 'project5-04', alt: 'Full page menu - Contact section' },
			{ fileName: 'project5-05', alt: 'Tablet mockup of image show page and phone mockup of contact modal' }
		],
		launchedSite: null,
		repoLink: null
	},
